...
$content = file_get_contents('/workspace/calculator.php');

// Define the old function
$old_function = 'function showRoute() {
...
$new_function = 'function showRoute() {
    if (!selectedFromOffice || !selectedToOffice) {
        alert("Пожалуйста, выберите оба офиса (отправка и получение).");
        return;
    }
...
file_put_contents('/workspace/calculator.php', $updated_content);

echo "showRoute function successfully updated in calculator.php\n";
?>