...
<head>
    ...
    <title>Форма заказа с картой</title>
...
<body>
    ...
    <div class="container">
        <h1>Форма заказа с картой</h1>
        
        <div class="order-form">
            <form id="deliveryForm" method="POST" action="process_order_map.php">
                ...
                <div id="routeInfo" class="route-info">
                    ...
                    <p><strong>Расстояние:</strong> <span id="distance">0</span> км</p>
                    <p><strong>Время в пути:</strong> <span id="duration">0</span> часов</p>
                    <p><strong>Стоимость доставки:</strong> <span id="cost">0</span> BYN</p>
                </div>
                
                <div class="form-group">
                    <label for="weight">Вес посылки (кг):</label>
                    <input type="number" id="weight" name="weight" min="0.1" max="30" step="0.1" required>
                </div>
                ...
                <div class="form-group">
                    <label for="home_address">Адрес доставки:</label>
                    <input type="text" id="home_address" name="home_address" required>
                </div>
                
                <div class="form-group">
                    <label for="pickup_city">Город получения:</label>
                    <input type="text" id="pickup_city" name="pickup_city">
                </div>
                
                <div class="form-group">
                    <label for="pickup_address">Адрес получения:</label>
                ...
                <div class="form-group">
                    <label for="desired_date">Желаемая дата доставки:</label>
                ...
                <div class="form-group">
                    <label>
                        <input type="checkbox" name="insurance" value="1"> Страховка
                    </label>
                    <label>
                        <input type="checkbox" name="packaging" value="1"> Упаковка
                    </label>
                    <label>
                        <input type="checkbox" name="fragile" value="1"> Хрупкое
                    </label>
                </div>
                
                <button type="submit" id="submitBtn" disabled>Создать заказ</button>
            </form>
        </div>
